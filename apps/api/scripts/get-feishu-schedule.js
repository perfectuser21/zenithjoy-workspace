#!/usr/bin/env node
'use strict';
// get Feishu 内容排期 records
// Usage: node get-feishu-schedule.js [--help] [--dry-run] [options]

const args = process.argv.slice(2);
if (args.includes('--help') || args.includes('-h')) {
  console.log('Usage: node get-feishu-schedule.js [--dry-run] [options]');
...
if (dryRun) {
  console.log(JSON.stringify({ ok: true, dryRun: true, script: 'get-feishu-schedule' }));
  process.exit(0);
}
