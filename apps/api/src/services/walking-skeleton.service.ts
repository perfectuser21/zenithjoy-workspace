...
export const HEARTBEAT_MODULES: Record<string, ModuleDescriptor> = {
  'line04-wechat-cs': { status: 'active', required_version: '1.0.92' },
  'line01-publish': { status: 'active', required_version: '1.0.1' },
  'line02-lead-gen': { status: 'active', required_version: '1.0.10' },
...
// 核心包按约定 install-pack/zenithjoy-agent-v2.0.59.tar.gz 从 COS 下载（live 源是已发布 manifest，本常量仅兜底）。
export const DEFAULT_REQUIRED_AGENT_VERSION = '2.0.59';
