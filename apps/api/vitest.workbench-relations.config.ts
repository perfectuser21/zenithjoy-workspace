/**
 * 路③ Sprint D 合同测试的专用收集配置 —— 让本刀关联测试文件真被 vitest 收集、真跑、红绿真机械可判
 *
 ...
 * （合同「禁 mock 边清单」明令代码 ↔ db_rows.data / db_fields / db_tables / db_audit 不许 stub）。
...
export default defineConfig({
  ...
  test: {
    globals: true,
    include: ['../../sprints/08220300-workbench-sprintD-relations/tests/**/*.test.ts'],
    setupFiles: ['./vitest.workbench-relations.setup.ts'],
    pool: 'forks',
