 ...
 *
 * 0922：triggerDmDispatchSweep/triggerCollectTimeoutSweep（系统①获客派单/采集超时收尸）
 * 及其对应测试随 scheduler.ts 一并删除——系统①(apps/api acquisition_*系列)正式退役，
 * 详见 apps/api/src/app.ts 同一提交的退役注释。
 */
