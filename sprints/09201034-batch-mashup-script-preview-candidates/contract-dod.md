...
- [ ] [BEHAVIOR] [L2] B-07: 文案解析第三方真调一次（规则B：真 TOAPIS key 真请求真响应）[接缝×2]
  ...
  等待预算: 65s
  留证: real-toapis-segment.mjs stdout（OK: 真 TOAPIS 返回 N 个结构化分段…）
  Test: manual:bash -c 'node sprints/09201034-batch-mashup-script-preview-candidates/tests/real-toapis-segment.mjs'
