...
# 干净 VM 无后端登录链路：build 注入 VITE_SKIP_AUTH=true → MOCK_USER(dev@zenjoymedia.media)，
# 并把该邮箱放进 VITE_SUPER_ADMIN_EMAILS → isSuperAdmin=true，使 /admin/customers 直接渲染 4 区。
# 后端端点仍由 spec 的 page.route stub 接管。
