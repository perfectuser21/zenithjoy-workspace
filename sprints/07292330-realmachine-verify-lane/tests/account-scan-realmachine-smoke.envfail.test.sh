#!/usr/bin/env bash
# account-scan-realmachine-smoke.envfail.test.sh — TDD Red 阶段
#
...
# account-scan-realmachine-smoke.test.sh（同 lint-*.test.sh 家族的 __tests__ 目录约定）。
#
# 用法: bash account-scan-realmachine-smoke.envfail.test.sh
set -uo pipefail
