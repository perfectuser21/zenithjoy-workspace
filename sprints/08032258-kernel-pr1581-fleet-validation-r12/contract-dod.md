...
- [ ] [BEHAVIOR] [L2] B-06: 双裁决完成后仅开放人工确认且未自动合并
  ...
  预期观察: gate 的 eligible_for_human_confirmation=true、human_confirmation_required=true、merge_performed=false，且 GitHub 返回 state=open、merged=false、merged_at=null、head SHA 精确匹配
  等待预算: 30s
