...
- Round 5 重绑定：本轮以冻结 task bundle 的顶层 `inputs` 为 SSOT，`attempt_id=c2f3006f-3c99-44db-8ad7-34db60580c9e`、`capability_snapshot_id=12e25b55-9b11-452b-95dc-a82e03984211`、`provider/account/model/machine=codex/team2/gpt-5.6-sol/us-mac-m4`。`review_feedback` 内所述 `267b7790-ee11-4bb7-8eeb-abf54a4b8e28`、`37895674-1ce2-48dd-8660-ba0d0021c738`、`team3` 是上一审查尝试引用的旧期望，不得覆盖本次顶层冻结输入；更早 Round 的 attempt/snapshot/account 同样过期。
...
ATTEMPT_ID="c2f3006f-3c99-44db-8ad7-34db60580c9e"
...
[ "$CAPABILITY_SNAPSHOT_ID" = "12e25b55-9b11-452b-95dc-a82e03984211" ]
