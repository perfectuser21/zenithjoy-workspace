...
- [ ] [ARTIFACT] 本 attempt 运行清单记录固定 repo/PR/base/final SHA 与完整 Fleet attestation
  Test: node -e "const d=require('./sprints/08040114-kernel-pr1581-fleet-validation-r13/evidence/run-manifest.json');if(d.run_id!=='a6e3ba3f-9856-4353-b05f-29f1049f7ca0'||d.attempt_id!=='6b434554-d9c5-4a65-a31a-238eceb86d44'||d.capability_snapshot_id!=='bd824197-70a6-48b6-9a26-93b452ed001f'||d.account!=='team2'||d.actual_final_sha!=='c305f6217da65bb69413c39e621b7e797e0fb189')process.exit(1)"
