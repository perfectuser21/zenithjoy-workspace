...
- `sprints/08051810-kernel-pr1581-fleet-validation-r37/sprint-prd.md`: 固化验证范围与可执行验收计划。
- `sprints/08051810-kernel-pr1581-fleet-validation-r37/contract-draft.md`: 由 Proposer 写入绑定目标 SHA 的最终验收脚本。
