...
- [ ] [ARTIFACT] Generator 只改本 sprint 目录，比较基线来自 Runner 冻结 workspace
  Test: bash -c ': "${HARNESS_WORKSPACE_START_SHA:?}"; test "$HARNESS_WORKSPACE_START_SHA" = "49fa4ebddde73b8f3d2d800793f2a13c79434b06"; test -z "$(git diff --name-only "$HARNESS_WORKSPACE_START_SHA"...HEAD | grep -v "^sprints/08050200-kernel-pr1581-fleet-validation-r35/" || true)"'
