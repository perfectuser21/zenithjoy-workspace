/**
 * WS7 — Lead 客户机自验脚本结构验证
 *
 * self-test 脚本本身在 mac 端，scp 到 xian-rog 跑（真扫码）。
 * 这里只验脚本结构，不真跑（真跑见 .agent-knowledge/path-2/lead-acceptance-sprint-b1.md 真证据）。
 */
