/**
 * WS4 — lead-writer.ts 调 multitenant Bitable writeRecord 写飞书 Lead 表
 */
...
import { writeLeadsFromComments } from '../../../../apps/api/src/services/lead-writer';
import { writeRecord } from '../../../../apps/api/src/services/feishu-bitable-multitenant';
