...
<!-- digest: d6fb016581bc415505da0ebb60e155ffbfdab357d1a7a12ba7fd2ee340d0c641 -->
...
| batch_mashup | customer_app | line05 | active | step1:客户的素材变成系统认得出内容的可用库（素材打标签）<br>step2:客户定下这批视频要按什么套路剪（槽位模板分配） | .github/workflows/scripts/smoke/material-tagging-smoke.sh<br>.github/workflows/scripts/smoke/mashup-slot-assignment-smoke.sh |
