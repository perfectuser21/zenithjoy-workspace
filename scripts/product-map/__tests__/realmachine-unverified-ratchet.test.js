 ...
 *
 * 迁移自 sprints/07292330-realmachine-verify-lane/tests/realmachine-unverified-ratchet.test.js
 *
 * 运行: node --test scripts/product-map/__tests__/realmachine-unverified-ratchet.test.js
 */
