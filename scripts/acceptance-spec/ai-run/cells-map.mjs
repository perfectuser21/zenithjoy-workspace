 ...
 *
 * 规程文件（acceptance-spec/line02-android.yaml）里 20 个 machine_db 格
...
export const CELLS_MAP = [
  ...
  { id: 'S10-c4', route: '/area/acquisition/leads', action: 'observe', wait_budget_ms: 30000,
    scenario_required: true, note: '红线11：覆盖场景需两轮数据对照' },
  ...
  { id: 'S13-c4', route: '/area/acquisition/outreach', action: 'observe', wait_budget_ms: 30000,
    scenario_required: true, note: '红线8：「被限制」不得显示为「已私信」——需频控场景数据' },
];
