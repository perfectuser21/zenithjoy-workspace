...
export function resolveCredentials(cli = {}, env = {}) {
  ...
  if (!email && !password) {
    throw new Error('无验收凭据：必须提供 ACCEPTANCE_EMAIL/ACCEPTANCE_PASSWORD 或 --email/--password；整轮 ai_incomplete 终止');
  }
  if (email && !password) {
