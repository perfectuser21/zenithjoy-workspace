contract_branch: cp-05242122-ws-fd7e56a3-ws3
workstream_index: 3
sprint_dir: sprints/zj-douyin-article-agent-port
...
- [ ] [ARTIFACT] `sprints/zj-douyin-article-agent-port/tests/ws3/install-pack.test.ts` 文件存在
...
- [ ] [BEHAVIOR] 旧版本 "1.1.25" 不再是 package.json 的 version 字段值
...
- [ ] [BEHAVIOR] publishers 复制目标路径含 `douyin-publisher`（确保粒度正确）
